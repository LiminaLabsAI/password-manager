...
|-------|------|--------|------------------|
| 0 | Bootstrap Security Core (target v0.1.0) | Not Started | Next.js + TS scaffold; Postgres + Prisma; libsodium KDF + crypto helpers; auth signup/login via master password; empty encrypted vault round-trip; smoke test; CI |
